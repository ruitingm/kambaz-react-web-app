    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Sift the flour, baking powder, sugar, and salt together.</li>
          <li>Make a well, then add milk and egg. Stir to combine.</li>
          <li> Scoop the batter onto waffle maker.</li>
          <li>Cook for two to three minutes.</li>
          <li>Continue cooking until brown.</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <img
          id="wd-teslabot"
          src="../public/images/teslabot.jpg"
          height="200px"
        />
      </div>
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <br />
          <input type="radio" name="radio-genre" id="ed-radio-comedy" />
